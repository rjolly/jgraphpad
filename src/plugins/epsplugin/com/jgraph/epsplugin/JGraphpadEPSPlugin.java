/* 
 * $Id: JGraphpadEPSPlugin.java,v 1.1.1.1 2005/08/04 11:21:58 gaudenz Exp $
 ...
 */
public class JGraphpadEPSPlugin implements JGraphEditorPlugin {

	/**
	 * Defines the path to the UI configuration to be merged into the existing
	 * UI configuration.
	 */
	public static String PATH_UICONFIG = "/com/jgraph/epsplugin/resources/ui.xml";
	...
	static {
		JGraphEditorResources
				.addBundles(new String[] { "com.jgraph.epsplugin.resources.strings" });
	}
	...
	public void initialize(JGraphEditor editor, Node configuration)
		...
		kit.addBundle(new JGraphpadEPSAction.AllActions(editor));
