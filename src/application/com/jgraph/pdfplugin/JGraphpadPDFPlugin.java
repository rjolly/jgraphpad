/* 
 * $Id: JGraphpadPDFPlugin.java,v 1.1.1.1 2005/08/04 11:21:58 gaudenz Exp $
...
/**
 * Plugin for using IText in JGraphpad Pro. Adds an savePDF action.
 */
public class JGraphpadPDFPlugin implements JGraphEditorPlugin {

	/**
	 * Defines the path to the UI configuration to be merged into the existing
	 * UI configuration.
	 */
	public static String PATH_UICONFIG = "/com/jgraph/pdfplugin/resources/ui.xml";
	...
	static {
		JGraphEditorResources
				.addBundles(new String[] { "com.jgraph.pdfplugin.resources.strings" });
	}
	...
	public void initialize(JGraphEditor editor, Node configuration)
		...
		kit.addBundle(new JGraphpadPDFAction.AllActions(editor));
