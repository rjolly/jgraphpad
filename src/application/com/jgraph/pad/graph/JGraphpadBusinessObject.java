/* 
 * $Id: JGraphpadBusinessObject.java,v 1.4 2005/09/11 08:50:27 gaudenz Exp $
 ...
 */
public class JGraphpadBusinessObject implements Cloneable, Serializable {
	 ...
	 */
	public JGraphpadBusinessObject() {
		this("");
	}
	 ...
	 */
	public JGraphpadBusinessObject(Object value) {
		setValue(value);
	}
	...
	public boolean isRichText() {
		return getValue() instanceof JGraphpadRichTextValue;
	}
	 ...
	 */
	public Object clone() {
		JGraphpadBusinessObject clone;
		try {
			clone = (JGraphpadBusinessObject) super.clone();
		} catch (CloneNotSupportedException e) {
			clone = new JGraphpadBusinessObject();
		}
		clone.setProperties(new Hashtable(getProperties()));
		if (isComponent()) {
			Object value = getValue();
			if (value instanceof JGraphpadHeavyweightRenderer) {
				clone.setValue(((JGraphpadHeavyweightRenderer) value).clone());
			}
		}
		return clone;
	}
