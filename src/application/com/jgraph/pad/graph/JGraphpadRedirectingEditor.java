 ...
 */
public class JGraphpadRedirectingEditor extends DefaultGraphCellEditor {
	...
	protected GraphCellEditor createGraphCellEditor() {
		return new JGraphpadRedirectingEditor.RealCellEditor();
	}
