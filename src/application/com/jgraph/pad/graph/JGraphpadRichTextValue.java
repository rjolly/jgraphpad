/* 
 * $Id: JGraphpadRichTextValue.java,v 1.2 2006/01/30 15:33:27 gaudenz Exp $
...
/**
 * Rich text replacement for string values in {@link JGraphpadBusinessObject}.
 * This requirs the {@link JGraphpadVertexView} to provide a rich text editor
 * and renderer.
 * 
 * @see JGraphpadGraphModel
 * @see JGraphpadVertexRenderer
 * @see RTFEditorKit
 */
public class JGraphpadRichTextValue implements Serializable, Cloneable {
	 ...
	 */
	public JGraphpadRichTextValue(Document document) {
	 ...
	 */
	public JGraphpadRichTextValue(String stringValue) {
	 ...
	 */
	public static String getPlainText(JGraphpadRichTextValue richText) {
