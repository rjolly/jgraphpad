 ...
 */
public class JGraphpadRichTextEditor extends DefaultGraphCellEditor {
	...
	protected GraphCellEditor createGraphCellEditor() {
		return new JGraphpadRichTextEditor.RealCellEditor();
	}
	...
	protected Container createContainer() {
		return new JGraphpadRichTextEditor.ModifiedEditorContainer();
	}
