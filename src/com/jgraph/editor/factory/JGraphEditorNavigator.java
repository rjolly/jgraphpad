/* 
 * $Id: JGraphEditorNavigator.java,v 1.6 2007/03/26 17:40:09 gaudenz Exp $
 ...
 */
public class JGraphEditorNavigator extends JPanel implements
	...
	/**
	 * @param isBackgroundImageVisible
	 *            The isBackgroundImageVisible to set.
	 */
		...
		public void paint(Graphics g) {
			...
			if (scrollPane != null && graph != null) {
				...
				if (isBackgroundImageVisible()
						&& scrollPane instanceof JGraphEditorDiagramPane) {
					JGraphEditorDiagramPane editorPane = (JGraphEditorDiagramPane) scrollPane;
	...
	/**
	 * Factory method to construct a new navigator. This implementation requires
	 * an editor in order to create the backing graph using the editor's
	 * factory.
	 */
	public static class FactoryMethod extends JGraphEditorFactoryMethod {
		 ...
		 */
		public static String NAME = "createNavigator";
		...
		/**
		 * Constructs a new factory method for the specified editor using
		 * {@link #NAME}.
		 * 
		 * @param editor
		 *            The editor to create the factory method for.
		 */
