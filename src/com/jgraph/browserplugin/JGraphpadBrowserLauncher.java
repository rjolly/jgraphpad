 ...
 * 
 * Latest version can be found at: <a
 * href="http://sourceforge.net/projects/browserlauncher/">SourceForge</a>.
 * 
...
public class JGraphpadBrowserLauncher {
	 ...
	 */
	private JGraphpadBrowserLauncher() {
	}
	...
	private static boolean loadClasses() {
		...
		case MRJ_3_0:
			try {
				...
				linkage = constructor
						.newInstance(new Object[] { JGraphpadBrowserLauncher.class });
			} catch (ClassNotFoundException cnfe) {
				errorMessage = cnfe.getMessage();
				return false;
			} catch (NoSuchMethodException nsme) {
	...
	public static void openURL(String url) throws IOException {
		...
		case WINDOWS_9x:
			...
			// VW opens browser without first displaying the distracting command
			// window
			// TODO: test quotes, for some reason I recall it does not work in
			// this case
