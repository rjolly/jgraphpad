/*
 * $Id: JGraphpadVertexRenderer.java,v 1.18 2007/08/28 14:44:13 gaudenz Exp $
 ...
 */
public class JGraphpadVertexRenderer extends VertexRenderer {
	 ...
	 * {@link JGraphpadGraphConstants#VERTEXSHAPE} attributes.
	 */
	 ...
	 */
	public JGraphpadVertexRenderer() {
	...
	public void paint(Graphics g) {
		...
		Dimension d = getSize();
		int b = borderWidth;
		Shape previousShape = cropToShape(g);
	 ...
	 *
	 * @param g
	 *          The graphics to crop.
	 * @return 	The shape before cropping
	 */
	protected Shape cropToShape(Graphics g) {
	...
	public Point2D getPerimeterPoint(VertexView view, Point2D source, Point2D p) {
		int shape = JGraphpadGraphConstants.getVertexShape(view
				.getAllAttributes());
		if (shape == SHAPE_DIAMOND) {
	...
	protected void resetAttributes() {
		...
		shape = JGraphpadGraphConstants.getVertexShape(view.getAllAttributes());
		isRichText = false;
		valueComponent = null;
	}
	...
	public void installAttributes(CellView view) {
		...
		shape = JGraphpadGraphConstants.getVertexShape(view.getAllAttributes());
		stretchImage = JGraphpadGraphConstants.isStretchImage(map);
