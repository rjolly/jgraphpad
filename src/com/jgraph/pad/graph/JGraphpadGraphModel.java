/* 
 * $Id: JGraphpadGraphModel.java,v 1.1.1.1 2005/08/04 11:21:58 gaudenz Exp $
 ...
 */
public class JGraphpadGraphModel extends DefaultGraphModel {
	 ...
	 */
	public JGraphpadGraphModel(List roots, AttributeMap attributes,
			ConnectionSet cs) {
	...
	public Object valueForCellChanged(Object cell, Object newValue) {
		...
		if (userObject instanceof JGraphpadBusinessObject) {
			JGraphpadBusinessObject businessObject = (JGraphpadBusinessObject) userObject;
	...
	protected Map handleAttributes(Map attributes) {
		...
		if (attributes != null) {
			...
			while (it.hasNext()) {
				...
				if (cell instanceof JGraphpadBusinessObject) {
					JGraphpadBusinessObject bo = (JGraphpadBusinessObject) cell;
